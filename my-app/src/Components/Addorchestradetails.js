...
const Addorchestradetails = () => {
  ...
  const addorchestra = async (e) => {
    e.preventDefault();
    const res = await fetch(
      "https://eventrra.000webhostapp.com/Admin/uploadOrchestra.php",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
    ...
    if (data == "success") {
      window.alert("Orchestra Added successfully !!");
  ...
  return (
    <div class="addorchestradetail-form">
      <section className="orchestradetail">
        <div className="container" id="cont-box">
          <header>Add orchestra Details</header>
          <form method="POST">
            <br />
            <input
              type="text"
            ...
            <input
              ...
              id="contact"
              autoComplete="off"
              placeholder="Enter orchestra contact"
              value={contact}
            ...
            <input
              ...
              id="ownername"
              autoComplete="off"
              placeholder="Enter orchestra owner"
              value={ownername}
...
export default Addorchestradetails;
