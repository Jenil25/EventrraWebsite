...
// import { getAllDemoFile } from '../functions'
...
const Home = () => {
    ...
    // useEffect(() => {
    //     const getDemo = async () => {
    //         const res = await axios.post("https://eventrra.000webhostapp.com/getAllDemoFile.php");
    //         setDemo(res.data);
    //     }
    //     getDemo();
    // }, []);
    ...
    //             <td className="clm5"><button className="btn btn-primary">Edit</button>&ensp;
    ...
    return(
        // <div>
        //     <br/><br/><center><h1>All demo</h1></center>
        //     <div><br/><br/><center>
